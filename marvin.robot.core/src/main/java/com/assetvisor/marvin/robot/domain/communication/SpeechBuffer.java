 ...
 * The speeches are added to the queue by calling the {@link #add(SpeechMessage)} method.
 */
@Component
public class SpeechBuffer {
    ...
    private final Queue<SpeechMessage> messageQueue = new LinkedList<>();
    ...
    public void add(SpeechMessage speech) {
        synchronized (lock) {
